/* func_0200d544 at 0x0200d544
 * Camera method: if playerID == CURR_PLAYER_ID, call ChangeState with settingBehaviourTable[16].
 */
...
void func_0200d544(struct Camera *thiz, u8 playerID)
{
    if (playerID != CURR_PLAYER_ID)
        return;
    _ZN6Camera11ChangeStateEPNS_5StateE(thiz, &settingBehaviourTable[16]);
}
