...
extern void *data_ov072_02122cbc[];
extern void *data_ov072_02122c9c[];
...
int func_ov072_02121a84(void *c) {
    ...
    case 0:
        angle = (s16)(Vec3_HorzAngle((char*)c + 0x5c, (char*)p + 0x5c) + 0x8000);
    ...
    case 2:
        *(int*)((char*)c + 0x98) = 0;
        ...
        else if (dist >= 0x226000 && dist < 0x384000)
    ...
    if (*(int*)((char*)c + 0x98) != 0) {
        _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(
            (char*)c + 0xd4, data_ov072_02122cbc[1], 0, 0x1000, 0);
    } else {
        _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(
            (char*)c + 0xd4, data_ov072_02122c9c[1], 0, 0x1000, 0);
    }
    ...
    *(int*)((char*)c + 0x130) = 0x1000;
    ...
    if (*(void**)((char*)c + 0x134) == data_ov072_02122cbc[1]) {
        int frame = (int)((*(unsigned int*)((char*)c + 0x12c) << 4) >> 16);
