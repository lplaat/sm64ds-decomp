/* func_0200d438 at 0x0200d438
 * Camera method: if playerID == CURR_PLAYER_ID, call ChangeState with settingBehaviourTable[24].
 */
...
void func_0200d438(struct Camera *thiz, u8 playerID)
{
    if (playerID != CURR_PLAYER_ID)
        return;
    _ZN6Camera11ChangeStateEPNS_5StateE(thiz, &settingBehaviourTable[24]);
}
