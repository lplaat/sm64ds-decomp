/* func_0200d5c0 at 0x0200d5c0
 * Checks if playerID == CURR_PLAYER_ID; if so, calls Camera::ChangeState
 * with a pointer to settingBehaviourTable[14] (offset 0x70 from base 0x0209B008).
 */
...
void func_0200d5c0(struct Camera *thiz, u8 playerID)
{
    if (playerID != CURR_PLAYER_ID)
        return;
    _ZN6Camera11ChangeStateEPNS_5StateE(thiz, &settingBehaviourTable[14]);
}
